...
--
-- NOTE: The live DB also contains an orphaned table `constraint_name_var`
-- (a migration artifact). It is NOT part of the schema and can be cleaned up:
...
-- View for monitoring slow queries on RLS-heavy tables
